  ...
  <div class="cardContainer">
    <div class="row">
      <div class="col-4">
        ...
        <q-img class="image-profile" src="https://www.rd.com/wp-content/uploads/2017/09/01-shutterstock_476340928-Irina-Bg.jpg"/>
      ...
      <div class="col-7">
        <div class="row" style="gap: 5px">
          <div class="col-12">
            <q-input standout v-model="userEmail" label="Email" disable />
          </div>
          <div class="col-12">
            <q-input standout v-model="userCountry" label="Country" disable />
          </div>
          <div class="col-12">
            <q-input standout v-model="userName" label="Email" disable />
          </div>
          <div class="col-12">
            <div v-for="(tenancy, index) in tenancies"
            :key="index">
              <q-chip clickable @click="openTenancy(tenancy)" color="primary" text-color="white" icon="event">
                {{tenancy.name}}
              </q-chip>
            </div>
          </div>
